...
export const SideBar = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <h4 className="text-xxl  italic">Services</h4>
        <ul>
          <li>
            <NextLink href="/menu" className="text-xl  italic">
              Delivery
            </NextLink>
          </li>
          <li>
            <NextLink href="/services/events" className="text-xl  italic">
              Private Events
            </NextLink>
          </li>
          <li>
            <NextLink href="/servides/worshops" className="text-xl  italic">
              Workshops
            </NextLink>
          </li>
        </ul>
